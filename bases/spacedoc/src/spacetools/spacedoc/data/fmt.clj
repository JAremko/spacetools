(ns spacetools.spacedoc.data.fmt
  ...
  (:require [clojure.core.match :refer [match]]
            ...
            [spacetools.spacedoc.data.node :as n]))
...
(defn- assoc-toc
  ...
  {:pre [(s/valid? :spacetools.spacedoc.data.node/root root)]
   :post [(s/valid? :spacetools.spacedoc.data.node/root %)]}
